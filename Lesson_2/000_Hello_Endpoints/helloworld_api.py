...
class Hello(messages.Message):
    ...
    greeting2 = messages.StringField(2)
...
class HelloWorldApi(remote.Service):
    ...
    def say_hello(self, request):
      return Hello(greeting="Hello Mundo")
    ...
    @endpoints.method(REQUEST_CONTAINER_PERIOD, Hello,
      path = "sayHelloByNameAndPeriod", http_method='GET', name = "sayHelloByNameAndPeriod")
    def say_hello_by_name_and_period(self, request):
      greet = "{} {}".format(request.period, request.name)      
      return Hello(greeting=greet)
